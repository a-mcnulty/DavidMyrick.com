<?php
	...
	$rows = getSalesByDay($dayRange, $sort);
		...
		<table border="0" cellpadding="0" cellspacing="0" style="width: 90%;">
			<tr>
				<td align="left" valign="top" class="dataHeader cufon">
					<a class="ajax" rel="manage_reports.php?report=report_top_sales_days.php&days=<?=$dayRange?>&sort=billlname <?=$theDir?>" onclick="return false">Date</a>
				</td>
				<td align="left" valign="top" class="dataHeader cufon">
					<a class="ajax" rel="manage_reports.php?report=report_top_sales_days.php&days=<?=$dayRange?>&sort=orderCount <?=$theDir?>" onclick="return false"># Orders</a>
				</td>
				<td align="left" valign="top" width="135" class="dataHeader cufon">
					<a class="ajax" rel="manage_reports.php?report=report_top_sales_days.php&days=<?=$dayRange?>&sort=dayTotal <?=$theDir?>" onclick="return false">Product $</a>
				</td>
			</tr>
			...
			?>
				...
				<tr>
					<td align="left" valign="top" class="<?=$class?> cufon">
						<?php echo displayDate($row['dateAdded']); ?>
					</td>
					<td align="left" valign="top" class="<?=$class?> cufon">
						<?=$row['orderCount']?>
						<?php
